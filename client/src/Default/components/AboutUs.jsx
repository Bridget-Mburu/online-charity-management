...
const AboutUs = () => {
  ...
  return (
    <div className="about-us">
      ...
      {/* New Sections in Grid */}
      <div className="section-grid">
        {/* First section */}
        <div className="section-item">
          <h2>Empowering Local Charities</h2>
          <img
          ...
          {readMore1 && (
            <p>
              We strive to provide a sustainable solution that fosters long-term relationships between charities and their supporters. Our platform helps charities enhance their visibility, engage with their donors, and address the challenges they face.
            </p>
          )}
        </div>
        ...
        <div className="section-item">
          ...
          />
          <p>
            The Covid-19 pandemic has severely impacted local charities, leading to a significant decline in donor contributions. Our mission is to address these economic challenges by creating a platform that connects charities with potential donors.
          </p>
        ...
        <div className="section-item">
          ...
          />
          <p>
            Many local charities struggle to find new donors due to a lack of visibility and outreach. Our platform aims to enhance the visibility of these organizations, showcasing their missions, projects, and the beneficiaries they serve.
          </p>
        ...
        <div className="section-item">
          ...
          />
          <p>
            We recognize that fostering ongoing relationships with donors is crucial for the success of any charity. Our system is designed to facilitate donor engagement by providing regular updates on projects, impact reports, and opportunities for involvement.
          </p>
        ...
        <div className="section-item">
          ...
          />
          <p>
            Our health and wellness fair brought together various health service providers to offer free screenings and health education to the community. This event not only promoted overall well-being but also connected attendees with local charities focused on health services.
          </p>
